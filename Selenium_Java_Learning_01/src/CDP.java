...
public class CDP {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		DevTools objDevTools = objChromeDriver.getDevTools();
			...
			objDevTools.send(Emulation.setDeviceMetricsOverride(1000, 1500, 50, false, java.util.Optional.empty(), java.util.Optional.empty(), java.util.Optional.empty(), java.util.Optional.empty(), java.util.Optional.empty(), java.util.Optional.empty(), java.util.Optional.empty(), java.util.Optional.empty(), java.util.Optional.empty()));
